    ...
    <div className="min-h-screen bg-neutral-50 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-semibold text-neutral-900">Personalized AI Results</h1>
            <p className="text-sm text-neutral-600">Generated by AI based on your profile details and learning preferences.</p>
          </div>
